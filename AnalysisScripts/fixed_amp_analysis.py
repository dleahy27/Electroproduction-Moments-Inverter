...
"""Compare a fixed generated point with its fitted amplitudes and moments."""
...
TRUTH_FILE = PROJECT_DIR / "InputFiles/Generated/fixed_photomoments.root"
FIT_FILE = PROJECT_DIR / "OutputFiles/fixed_photomoments_unpolarized_fit.root"
TRUTH_TREE = "genMoments"
FIT_TREE = "fitResults"
SHOW_PLOTS = False

OUTPUT_DIR = PROJECT_DIR / "AnalysisScripts/outputs/fixed_amp_analysis" / FIT_FILE.stem
