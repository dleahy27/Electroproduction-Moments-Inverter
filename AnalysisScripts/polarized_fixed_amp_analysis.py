...
"""Compare generated and fitted polarized fixed amplitudes."""
...
TRUTH_FILE = PROJECT_DIR / "InputFiles/Generated/fixed_both_moments.root"
FIT_FILE = PROJECT_DIR / "OutputFiles/fixed_both_fit.root"
TRUTH_TREE = "genMoments"
FIT_TREE = "fitResults"
SHOW_PLOT = False

OUTPUT_DIR = (
    PROJECT_DIR / "AnalysisScripts/outputs/polarized_fixed_amp_analysis"
    / FIT_FILE.stem
)
