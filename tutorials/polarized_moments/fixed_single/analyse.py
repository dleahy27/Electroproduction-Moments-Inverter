...
"""Compare one generated and fitted single-polarization example.

Generation and fitting use the same explicit gauge, so complex amplitudes can
be compared directly after choosing either the initial or recoil case.
"""
...
# Settings: use "initial" or "recoil" after running this tutorial.
POLARIZATION = "initial"
CASE_DIR = PROJECT_DIR / "tutorials/polarized_moments/fixed_single"
TRUTH_FILE = CASE_DIR / f"output/generated/fixed_{POLARIZATION}_moments.root"
FIT_FILE = CASE_DIR / f"output/root/fixed_{POLARIZATION}_fit.root"
TRUTH_TREE = "genMoments"
FIT_TREE = "fitResults"
SHOW_PLOT = False

OUTPUT_DIR = (
    CASE_DIR / "output/plots" / POLARIZATION
)
