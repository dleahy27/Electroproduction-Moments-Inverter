...
Timing slopes assume cost proportional to the number of starts. Separate
status counts check that a speed difference did not change convergence, and
best-fit branches provide a numerical agreement check.
"""
...
from tutorials.analysis_utils import PROJECT_DIR, save_figure, style_axis, wrap_phase


# Settings: edit the timing and external BruFit paths when needed.
CASE_DIR = PROJECT_DIR / "tutorials/electroproduction_paper/performance"
NUMERIC_TIMES = CASE_DIR / "output/numeric_times.csv"
ANALYTIC_TIMES = CASE_DIR / "output/analytic_times.csv"
ANALYTIC_FIT = CASE_DIR / "output/root/gradient_analytic_0.root"
NUMERIC_FIT = CASE_DIR / "output/root/gradient_numeric_0.root"
EMI_FIT = PROJECT_DIR / "tutorials/electroproduction_paper/main/output/root/e_rho_fit_0.root"
BRUFIT_DIR = (
...
def dataframe_columns(frame):
    """Convert ROOT's column-name proxy objects into ordinary strings."""
